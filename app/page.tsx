...
<div className="headerBrand">
  <div className="logoBlock" aria-hidden>
    <div className="logoMark logoMarkImg" aria-hidden>
      <img src="/logo.png" alt="" className="logoEtsImg" decoding="async" />
    </div>
...
<img src="/social-github.png" alt="" aria-hidden width={22} height={22} style={{ display: "block", borderRadius: "4px" }} />
</a>
</div>
